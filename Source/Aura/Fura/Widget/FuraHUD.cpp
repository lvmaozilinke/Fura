...
UAttributeMenuWidgetController_F* AFuraHUD::GetAttributeMenuWidgetController(const FWidgetControllerParamsF& WCParams)
{
	if (AttributeMenuWidgetController == nullptr)
	{
		AttributeMenuWidgetController = NewObject<UAttributeMenuWidgetController_F>(
